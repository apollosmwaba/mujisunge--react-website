...
const Cart = ({ isOpen, onClose }: CartProps) => {
  ...
  const handleCheckout = () => {
    ...
    let message = 'Hello Mujisunge Farm, I would like to inquire about your services:\n\n';
    cart.forEach(item => {
      message += `- ${item.name} (x${item.quantity})\n`;
    });
    message += `\nPlease provide more information about these services and pricing.`;
    ...
    <>
      ...
      >
        <div className="p-5">
          ...
          {cart.length > 0 && (
            <>
              <div className="text-center text-lg font-semibold mb-5 pt-4 border-t border-gray-300 dark:border-gray-600 text-[#2e8b57]">
